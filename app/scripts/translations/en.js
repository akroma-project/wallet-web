...
/* Onboarding */
ONBOARD_welcome_title           :  'Welcome to wallet.akroma.org',
...
ONBOARD_blockchain_content__5   :  'When you see your balance on wallet.akroma.org or view your transactions on [etherscan.io](https://etherscan.io), you are seeing data on the blockchain, not in our personal systems.',
...
FOOTER_1                        :  'Free, open-source, client-side interface for generating Ethereum wallets &amp; more. Interact with the Ethereum blockchain easily &amp; securely. Double-check the URL ( wallet.akroma.org ) before unlocking your wallet.',
...
NODE_Warning                    :  'Your node must be HTTPS in order to connect to it via wallet.akroma.org. You can [download the Akroma Web Wallet repo & run it locally](https://github.com/akroma-project/akroma-wallet-web/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
...
TXFEE_Desc                      :  'The TX Fee is paid to miners for including your TX in a block. Is is the `gas limit` * `gas price`. [You can convert GWEI -> ETH here](https://wallet.akroma.org/helpers.html)',
...
HELP_14_Desc_1                  :  'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, wallet.akroma.org can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto).',
HELP_14_Title                   :  '14) Some sites randomize (seed) the private key generation via mouse movements. wallet.akroma.org doesn\'t do this. Is the random number generation for Akroma Web Wallet safe?',
...
HELP_3_Desc_3                   :  'Navigate to the wallet.akroma.org "View Wallet Info" page.',
...
HELP_5_Desc_1                   :  'You can run wallet.akroma.org on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page.',
HELP_5_Desc_7                   :  'wallet.akroma.org is now running entirely on your computer.',
...
HELP_5_Desc_9                   :  'As we are constantly updating wallet.akroma.org, we recommend you periodically update your saved version of the repo.',
HELP_5_Title                    :  '5) How do I run wallet.akroma.org offline/locally?',
...
HELP_8_Desc_2                   :  'If wallet.akroma.org goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your Akroma out of Akroma Web Wallet because it\'s not in Akroma Web Wallet. It\'s in whatever wallet your generated via our site.',
...
HELP_Desc                       :  'Do you see something missing? Have another question? [Get in touch with us](mailto:support@wallet.akroma.org), and we will not only answer your question, we will update this page to be more useful to people in the future!',
HELP_FAQ_Title                  :  'More Helpful Answers to Frequent Questions',
HELP_Remind_Desc_1              :  '**Ethereum, wallet.akroma.org & Akroma Web Wallet CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your ETH to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost Akroma**.',
HELP_Remind_Desc_2              :  'wallet.akroma.org & Akroma Web Wallet CX are not "web wallets". You do not create an account or give us your Akroma to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain.',
...
HELP_SecCX_Desc_6               :  'If we were to encrypt these items, you would need to enter a password each time you wanted to view your account balance or view the nicknames. If this concerns you, we recommend you use wallet.akroma.org instead of this Chrome Extension.',
